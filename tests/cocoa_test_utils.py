...
carries what is des_y3's alone - the examples table covering BOTH
DES data generations (examples 1-2: the Y3 data set; examples 3-4:
its Y1 twin, each with its own synthetic NLA dataset named per
example), the TATT point, the accuracy knobs, and the
...
# 0.000948 there; the historical single-grid default reached 4.3
# across the prior).
